...
<a aria-label="<?php echo esc_attr( oceanwp_theme_strings( 'owp-string-scroll-top', false ) ); ?>" href="#" 
	id="scroll-top" class="scroll-top-<?php echo esc_attr( $position ); ?>"><?php oceanwp_icon( $arrow ); ?></a>


<div class="floating-cart-one position-relative hidden" id="showBottomCart" width="24" height="24">
