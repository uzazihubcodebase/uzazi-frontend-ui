		  ...
		  <?php //do_action( 'ocean_header' ); ?>
		   ...
		   <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
			  ...
			  <div class="search-box bg-dark position-relative">
			    <div class="search-wrap">
			      ...
			      <form id="search-form" class="text-lg-center text-md-left pt-3"
			             role="search" method="get"  action="<?php echo get_site_url(); ?>/shop">
			        <input type="text" class="search-input" placeholder="Search..." name="s" />
				    <svg class="search">
				      <button type="submit"> <use xlink:href="#search"></use> </button>
				    </svg>
			      </form>
			                ...
			                <div class="mini-cart-item d-flex border-bottom pb-3">
			                  <div class="col-lg-2 col-md-3 col-sm-2 me-4">
			                    <a href="#" title="product-image">
			                      <img src="https://uzazihub.com/wp-content/uploads/2023/12/IDE_7656-scaled.jpg" class="img-fluid" alt="single-product-item">
			                    </a>
			                  </div>
			                  <div class="col-lg-9 col-md-8 col-sm-8men">
			                    <div class="product-header d-flex justify-content-between align-items-center mb-3">
			                      <h4 class="product-title fs-6 me-5">Baby Shoes</h4>
			  ...
			  <header id="header" class="site-header text-black">
			    <nav id="header-nav" class="navbar navbar-expand-lg  section-width-medium">
			      <div class="container-lg">

			        <a class="navbar-brand" href="<?php echo get_site_url(); ?>">
			          <img src="https://uzazihub.com/wp-content/uploads/2023/09/cropped-logo-1.png" class="logo" alt="logo">
			        </a>
			        
			        <button class="navbar-toggler d-flex d-lg-none order-3 p-1 ms-2" type="button" data-bs-toggle="offcanvas"
			        ...
			        <div class="offcanvas offcanvas-end search-box-main" >
			          <form id="search-form" class="text-lg-center text-md-left pt-1 pb-1" action="<?php echo get_site_url(); ?>/shop" method="get">
			            <input type="text" class="search-input" placeholder="Search Pregnancy, Wellness and Baby Products ...." name="s" />
			            <svg class="search search-main">
			        ...
			        <div class="user-items ps-0 ps-md-5 user-items-small-wide">
			          <ul class="d-flex justify-content-end list-unstyled align-item-center m-0">

			            <li class="pe-3">
			              <a href="<?php echo get_site_url();?>/cart" class="border-0">
			                <div class="shopping-cart menu-top-icon position-relative" width="24" height="24">
			                  <img src="<?=IMAGES?>/shopping-cart.png" alt="" />
			                  <?php $theCount = user_cart_counter(); ?>
			                  <span class="cart-counter"> <?php echo $theCount; ?> <span>  
			                </div>
			              </a>
			            </li>

			            <li>
			              <a href="<?php if(is_user_logged_in()){  echo get_site_url()."/whislist";  
			                        } else { echo get_site_url()."/my-account";  }  ?> " class="border-0">
			                <div class="whislist menu-top-icon" width="24" height="24">
			            ...
			            <li class="pe-3">
			              <a href="<?php echo get_site_url();?>/my-account" class="border-0">
			                <div class="user menu-top-icon" width="24" height="24">
			                  <img src="<?=IMAGES?>/user.png" alt="" />
			                </div>
			              </a>
			            </li>
			            
                        <!-- data-bs-toggle="modal" data-bs-target="#modallong" class="shopping-cart menu-top-icon position-relative" -->

			            <li>
			              <a href="<?php echo get_site_url();?>/help" class="border-0">
			                <div class="settings  menu-top-icon-2 menu-top-icon-3" width="24" height="24">
			            ...
			            <li>
			              <a href="#" class="search-item border-0 lg-hidden md-hidden" 
			                   data-bs-toggle="collapse" data-bs-target="#search-box" 
			                   aria-label="Toggle navigation">
			                 <div class="search  menu-top-icon-2" width="24" height="24">
			    ...
			    <nav id="header-nav" class="navbar navbar-expand-lg navbar-dark">
			      <div class="container-lg">
			        <div class="offcanvas offcanvas-center" tabindex="-1" id="bdNavbar">
			          <div class="offcanvas-header px-4 pb-0">
			           
			            <a class="navbar-brand ps-3" href="<?php echo get_site_url(); ?>">
			              <img src="https://uzazihub.com/wp-content/uploads/2023/09/cropped-logo-1.png" class="logo" alt="logo">
			            </a>
			          ...
			          <div class="offcanvas-body">
			            <ul id="navbar" class="navbar-nav fw-bold justify-content-center align-items-center flex-grow-1">
			              
			              <li class="nav-item">
			                <a class="nav-link me-5" href="<?php echo get_site_url(); ?>">Home</a>
			              </li>

			              <li class="nav-item">
			                <a class="nav-link me-5" href="<?php echo get_site_url();?>/product-categories">All Categories</a>
			              </li>

			              <li class="nav-item">
			                <a class="nav-link me-5" href="<?php echo get_site_url();?>/hot-deals">Hot Deals</a>
			              </li>
			                ...
			                <ul class="dropdown-menu fw-bold">
			                 <?php
								...
								if (!empty($product_categories) && !is_wp_error($product_categories)) { 
					             ...
					             <li>
					               <a href="<?php echo get_term_link($category); ?>" class="dropdown-item">
			              ...
			              <li class="nav-item dropdown">
			                ...
			                <ul class="dropdown-menu fw-bold">
			                  <li>
			                    <a href="<?php echo get_site_url();?>/about" class="dropdown-item">About Uzazi </a>
			                  </li>
			                  
			                </ul>
			              </li>
			              <li class="nav-item">
			                <a class="nav-link me-5" href="<?php echo get_site_url();?>/vendor-register">Become a Vendor</a>
			              </li>
			              ...
			              <li class="nav-item dropdown">
			                ...
			                <ul class="dropdown-menu fw-bold">
			                  <li>
			                    <a href="<?php echo get_site_url();?>/return-replacement-policy" class="dropdown-item">Return and Replacement Policy</a>
			                  </li>
			                  <li>
			                    <a href="<?php echo get_site_url();?>/frequently-asked-questions-faqs" class="dropdown-item">Faq</a>
			                  </li>
			              ...
			              <li class="nav-item">
			                <a class="nav-link me-5" href="<?php echo get_site_url();?>/contact">Contact</a>
			              </li>
